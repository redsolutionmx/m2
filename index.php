...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
		...
		<div class="container">
			<div class="row">
				<div class="header-inner">
					<h1><a href="index.html">M2 Bienes Raices<span>.</span></a></h1>
					<nav role="navigation">
						<ul>
							<li><a href="buy.html">Compra</a></li>
							<li><a href="rent.html">Renta</a></li>
							<li><a href="properties.html">Anunciate</a></li>
							<li><a href="login.html">Login</a></li>
							<li class="call"><a href="tel://+52 55 56746618 "><i class="icon-phone"></i> +52 55 56746618 </a></li>
							<li class="cta"><a href="contact.html">Contactanos</a></li>
						</ul>
					</nav>
				</div>
			</div>
	...
	<aside id="fh5co-hero" clsas="js-fullheight">
        ...
        <form action="" method="post" enctype="multipart/form-data" >
            <div class="search">
                Encuentra tu hogar ideal en M2
                <br />
                <br />
                <div class="forms">
                ...
                <div class="forms">
                    <label>¿En donde lo necesitas?</label><br />
                    <input class="input" name="lugar" value="" placeholder="Calle, Delegación o C.P." >
                </div>
                <div class="forms">
                ...
                <div class="forms">
                    <label>¿Lo deseas amueblado?</label>
                    <br />
                     <div class="radios"><input type="radio" name="gender" value="si"> si </div>
